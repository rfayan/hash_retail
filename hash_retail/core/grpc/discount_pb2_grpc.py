...
from hash_retail.core.grpc import discount_pb2 as discount__pb2
...
def add_DiscountServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler("discount.Discount", rpc_method_handlers)
